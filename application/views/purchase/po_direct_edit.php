  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.addRow', function(e) {
      ...
      <?php foreach ($active_items as $item) { ?>
        newRow += '                    <option value="<?php echo $item->product_id ?>"><?php echo $item->product_name; ?></option>';
      <?php } ?>
      newRow += '                </select>';
      newRow += '            </td>';
      ...
      newRow += '            <td>';
      newRow += '              <button type="button" class="btn btn-success addRow" title="Add"><i class="fa fa-plus"></i></button>';
      newRow += '              <button type="button" class="btn btn-danger deleteRow" title="Delete"><i class="fa fa-minus"></i></button>';
      newRow += '            </td>';
      newRow += '        </tr>';
    ...
    if (item_id != '') {
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#description' + row_no).val(response.description);
