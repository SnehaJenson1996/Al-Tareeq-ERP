                ...
                foreach ($records as $row) { ?>
                    ...
                    <tr>
                        ...
                        <td class="action-icons">
                            <a href="<?php echo base_url() . 'index.php/Hr/edit_salary_structure/' . $row->sid; ?>" title="Edit"><i class="fa fa-edit"></i><?php echo $this->session->userdata('edit_icon'); ?>
                            </a>
                            ...
                            <a href="<?php echo base_url() . 'index.php/Hr/delete_basic_salary/' . $row->sid; ?>"
                                ...
                                echo !empty($icon) ? $icon : '<i class="fa fa-trash"></i>';
                                ?>
                            </a>
                        </td>
                    </tr>
