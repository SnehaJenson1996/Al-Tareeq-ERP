<div class="card">
    ...
    <div class="card-header">
        <h4>Edit Commission Transaction</h4>
    </div>

    <div class="card-body">

        <form method="post" action="<?php echo base_url(); ?>index.php/Hr/update_commission_transaction">

            <input type="hidden"
                name="transaction_id"
                value="<?php echo $record->transaction_id; ?>">
                    ...
                    <select  id="invoice_id" name="invoice_id" class="form-control" required>
                        ...
                        <?php foreach ($invoice_list as $row) { ?>
                            ...
                            <option value="<?php echo $row->invoice_id; ?>"
                                <?php if ($row->invoice_id == $record->invoice_id) echo "selected"; ?>>
                    ...
                    <select id="sales_rep_id" name="sales_rep_id" class="form-control" required>
                        ...
                        <?php foreach ($sales_rep as $row) { ?>
                            ...
                            <option value="<?php echo $row->sales_rep_id; ?>"
                                <?php if ($row->sales_rep_id == $record->sales_rep_id) echo "selected"; ?>>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="invoice_amount" name="invoice_amount" class="form-control" readonly value="<?php echo $record->invoice_amount; ?>">
                </div>

                <div class="col-md-4">
                    <label>Commission %</label>
                    <input type="text" id="commission_percent"
                        name="commission_percent"
                        class="form-control" readonly
                        value="<?php echo $record->commission_percent; ?>">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="commission_amount"
                        ...
                        class="form-control" readonly
                        value="<?php echo $record->commission_amount; ?>">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date"
                        name="eligible_date"
                        class="form-control"
                        value="<?php echo $record->eligible_date; ?>">
                ...
                <div class="col-md-4">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="Pending"
                            <?php if ($record->status == 'Pending') echo "selected"; ?>>
                            Pending
                        </option>

                        <option value="Eligible"
                            <?php if ($record->status == 'Eligible') echo "selected"; ?>>
                            Eligible
                        </option>

                        <option value="Approved"
                            <?php if ($record->status == 'Approved') echo "selected"; ?>>
                            Approved
                        </option>

                        <option value="Paid"
                            <?php if ($record->status == 'Paid') echo "selected"; ?>>
                            Paid
                        </option>

                        <option value="Rejected"
                            <?php if ($record->status == 'Rejected') echo "selected"; ?>>
                            Rejected
                        </option>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <textarea
                        name="remarks"
                        class="form-control"
                        rows="4"><?php echo $record->remarks; ?></textarea>
