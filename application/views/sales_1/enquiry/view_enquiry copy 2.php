                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade  <?= isset($enquiry_data['enquiry_status'])&&$enquiry_data['enquiry_status']==1?'active show ':""?>" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      ...
                                      <div class="site-survey-toggle">
                                          ...
                                          <label class="switch">
                                              <input type="hidden" name="allow_site_survey" value="0">
                                                  <input type="checkbox" id="siteSurveyToggle" name="allow_site_survey" value="1"
                        ...
                        <div class="tab-pane fade <?= isset($enquiry_data['enquiry_status'])&&$enquiry_data['enquiry_status']==2?'active show ':""?>" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                          <form method="post" action="<?= base_url()?>index.php/Sales/accept_site_survey/<?= $enquiry_data['enquiry_id']?>">
                              ...
                              <div class="form-group">
                                      ...
                                      <select name="employee_survey" id="employee_survey" class="form-control">
                                          ...
                                          <option value="<?= $employee->employee_id ?>"
                                              <?= (isset($survey_data) && $survey_data['assigned_person_id'] == $employee->employee_id) ? "selected" : "" ?>>
                                      ...
                                      <div class="col-md-4 form-group">
                                          ...
                                          <div class="col-md-6 col-sm-6 form-group">
                                            ...
                                            <input type="datetime-local" 
                                                  ...
                                                  class="form-control" 
                                                  value="<?= isset($enquiry_data['enquiry_date']) 
                                                      ? date('Y-m-d\TH:i', strtotime($enquiry_data['enquiry_date'])) 
                                                      : date('Y-m-d\TH:i') ?>" 
                                                  required>
                                        </div>
                                      </div>
                                  ...
                                  <div class="col-md-2 form-group">
                                      ...
                                      <input type="date" 
                                            name="actual_date" 
                                            id="actual_date" 
                                            value="<?= !empty($survey_data['actual_date']) 
                                                        ? date('Y-m-d', strtotime($survey_data['actual_date']))  
                                                        : '' ?>"  
                                            class="form-control">
                                  </div>
                                  ...
                                  <div class="col-md-4 form-group">
                                      <div class="col-md-6 col-sm-6 form-group">
                                          ...
                                          <input type="datetime-local" 
                                                ...
                                                class="form-control" 
                                                value="<?= !empty($survey_data['actual_start_time']) 
                                                            ? date('Y-m-d\TH:i', strtotime($survey_data['actual_start_time'])) 
                                                            : '' ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-md-4 form-group">
                                      <div class="col-md-6 col-sm-6 form-group">
                                          ...
                                          <input type="datetime-local" 
                                                ...
                                                id="actual_end_time" 
                                                class="form-control" 
                                                value="<?= !empty($survey_data['actual_end_time']) 
                                                            ? date('Y-m-d\TH:i', strtotime($survey_data['actual_end_time'])) 
                                                            : '' ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="col-md-2 form-group">
                                      ...
                                      <input type="text" 
                                            name="actual_hours" 
                                            id="actual_hours"  
                                            value="<?= !empty($survey_data['actual_hours']) 
                                                        ? $survey_data['actual_hours'] 
                                                        : '' ?>" 
                              ...
                              <div class="form-group">
                                  ...
                                  <textarea name="survey_comments" 
                                            id="survey_comments" 
                                            class="form-control" 
                                            rows="3"><?= !empty($survey_data['survey_comments']) 
                                                          ? $survey_data['survey_comments'] 
                                                          : '' ?></textarea>
                              </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <textarea name="material_details" 
                                            id="material_details" 
                                            class="form-control" 
                                            rows="3"><?= !empty($survey_data['material_details']) 
                                                          ? $survey_data['material_details'] 
                                                          : '' ?></textarea>
                              </div>
                                    <!-- Attachments -->
                                    <div class="row">
                        ...
                        <!------ESTIMATION------------>
                      <div class="tab-pane fade <?= isset($enquiry_data['enquiry_status'])&&$enquiry_data['enquiry_status']==3?'active show':""?>"   id="contact" role="tabpanel" aria-labelledby="contact-tab">
                         <!-- Survey Comments -->
                              <div class="form-group">
                                  <label for="survey_comments">Survey Comments</label>
