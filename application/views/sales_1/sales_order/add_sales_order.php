    ...
    <div class="clearfix"></div>
        ...
        <form action='<?php echo base_url().'index.php/'; ?>Sales/add_sales_order' method='post' >
        <div class="x_content">
            <div class="item form-group">
                <label class="col-form-label col-md-2 col-sm-1 label-align" >Approved Quotation <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 ">
                    <select class="form-control" name="quotation_id" id="quotation_id" onchange='this.form.submit()'>
                        <option value="">Select Quotation</option>
                        <?php foreach($approved_quotations as $approved_quotation) { ?>
                            <option value="<?php echo $approved_quotation->quotation_id;?>" <?php if(isset($quotation) && $approved_quotation->quotation_id == $quotation['quotation_id']) echo 'selected'; ?>><?php echo $approved_quotation->quotation_code.'/Rev-'.$approved_quotation->quotation_revision;?></option>
                        <?php } ?>
                    </select>
                </div>
        ...
        <form action='<?php echo base_url().'index.php/'; ?>Sales/add_sales_order_data' method='post' >
            <div class="x_content">
                <input type='hidden' name='quotation_id' value='<?php echo $quotation['quotation_id']; ?>' />
                <ul class="stats-overview">
                    <li>
                        <span class="name"> Customer </span>
                        <span class="value text-success"> <?php echo $quotation['customer_name']; ?>  </span>
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="name"> Order Code </span>
                        <span class="value text-success"> <?php echo $pi_code; ?> </span>
                    </li>
                </ul>
            </div>
                    ...
                    <table class="table-striped table-bordered" style="width:100%;font-size:10px">
                                <thead>
                                    <tr>
                                        ...
                                        <td style='width:3%;text-align:center'>Qty</td>
                                        <!-- <td style='width:3%;text-align:center'>Alloc Qty</td> -->
                                ...
                                <tbody id='mytbody'>
                                <?php $i=0;$subtotal=0;$additional_discount=0;$total_quantity=0;$total_taxable=0;$total_vat=0;$total_amt=0;$vat_percent = $quotation['vat_percent']/100;
                                foreach($quotation_details as $detail){ ?>
                                    <?php if($detail->pending_quantity > 0){ ?>
                                    ...
                                    <?php 
                                        ...
                                        //stock availability
                                        $stock_availability = 'No-Stock';
                                        //$allocated_stock = 0;
                                        if($detail->current_stock > 0){
                                            if($detail->current_stock >= $detail->pending_quantity){
                                                $stock_availability = 'Ex-Stock';
                                                //$allocated_stock = $detail->pending_quantity;
                                            }else if($detail->current_stock < $detail->pending_quantity){
                                                  $stock_availability =  'Partial';
                                                  //$allocated_stock = $detail->current_stock;
                                            }
                                        }
                                    ...
                                    <tr id='<?php echo 'addr'.$i; ?>'>
                                        ...
                                        <td><?php echo $detail->item_model.' '.$detail->item_description ?><input type='hidden' name='item_id[]' id='<?php echo 'item_id'.$i; ?>' value='<?php echo $detail->item_id; ?>' /><input type='hidden' name='detail_id[]' id='<?php echo 'detail_id'.$i; ?>' value='<?php echo $detail->detail_id; ?>' /></td>
                                        <td><input type='text' class='form-control quantity' name='quantity[]' id='<?php echo 'quantity'.$i; ?>' value='<?php echo $detail->pending_quantity; ?>' oninput='calculate_row_values(<?php echo $i; ?>)' /></td>
                                        <!-- <td class='right-align'><input type='number' class='form-control' min=0 max='<?php //echo $detail->current_stock; ?>' name='allocated_quantity[]' id='<?php //echo 'allocated_quantity'.$i; ?>' value='<?php //echo $allocated_stock; ?>'  /></td> -->
                                        ...
                                        <td class='right-align'><?php echo $quotation['vat_percent'].'%'; ?></td>
                                        ...
                                        <td style='text-align:center'><?php echo $stock_availability;  ?></td>
                                ...
                                <tr class='right-align'>
                                    ...
                                    <td><input type='hidden' id='vat_percent' name='vat_percent' value='<?php echo $quotation['vat_percent']; ?>' /><span id='total_vat'><?php echo $total_vat; ?></span></td>
            ...
            <div class="x_content">
                        <div class="item form-group">
                            <label class="col-form-label col-md-2 col-sm-1 label-align" >Supplier Ref</label>
                            <div class="col-md-10">
                                <input type='text' name='supplier_ref' class='form-control'  value='' />
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-2 col-sm-1 label-align" >Other Reference</label>
                            <div class="col-md-10">
                                <input type='text' name='other_ref' class='form-control'  value='' />
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-2 col-sm-1 label-align" >Dispatch document No</label>
                            <div class="col-md-10">
                                <input type='text' name='dispatch_document_number' class='form-control'  value='' />
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-2 col-sm-1 label-align" >Mode/Terms of Payment</label>
                            <div class="col-md-10">
                                <input type='text' name='payment_terms' class='form-control'  value='AS AGREED' />
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-10 col-sm-10 ">
                                <input type='text' name='dispatch_through' class='form-control'  value='' />
                            </div>
                        </div>
                        <div class="item form-group">
                         ...
                         <div class="item form-group">
                            ...
                            <div class="col-md-10">
                                <input type='text' name='delivery_terms' class='form-control'  value='' />
                            </div>
                        </div>
                        ...
                        <div class="item form-group">  
                            ...
                            <div class="col-md-6">
                            <button type="submit" class="btn btn-success btn-primary" id='save_button'>Save</button>
                            </div>
                        </div>
