...
<div class="x_content mt-3">
  <div class="row">
    ...
    <div class="col-md-1 col-sm-9 col-xs-9">
      <input type="text" class="form-control" name="inv_vat_amount" id="inv_vat_amount">
    </div>

    <label class="control-label col-md-1 col-sm-3 col-xs-3">Grand Total</label>
    <div class="col-md-2 col-sm-9 col-xs-9">
      <input type="text" class="form-control" name="inv_grand_total" id="inv_grand_total">
    </div>
  </div>
  ...
  <div class="row mt-3">
  <!-- Payment Mode -->
  <label class="control-label col-md-2 col-sm-3 col-xs-3">Payment Mode</label>
  <div class="col-md-2 col-sm-9 col-xs-9">
...
<script>
    ...
    if(del_id) {
        $.ajax({
            ...
            type: 'POST',
            data: { del_id: del_id, so_id: so_id, qtn_id: qtn_id ,enq_id:enq_id },
            dataType: 'json',
