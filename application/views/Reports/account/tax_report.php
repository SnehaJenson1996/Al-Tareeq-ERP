...
<form id="ledger_report_form" method="post" action="<?php echo base_url('index.php/Accounts/tax_report_details'); ?>">
      ...
      <div class="form-group row mb-4">
        ...
        <!-- Submit Button -->
        <div class="col-md-3">
          <button type="submit" id="generate_report" class="btn btn-success btn-sm">
            <i class="fa fa-search"></i> Generate Report
          </button>
        </div>
      </div>
    </form>
<button type="button" class="btn btn-primary btn-sm mb-3" onclick="printReport()">
...
function printReport() {
  ...
  printWindow.document.write(`
    <div class="print-header">
      <img src="<?php echo base_url('public/header/2.png'); ?>" alt="Header">
    </div>
  `);
