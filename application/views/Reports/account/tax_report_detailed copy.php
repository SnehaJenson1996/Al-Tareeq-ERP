        ...
        <td>
           <?php 
            switch ($row->voucher_type) {
              case 'J': echo "Journal Entry"; break;
              case 'C': echo "Credit Note"; break;
              case 'D': echo "Debit Note"; break;
              case 'S': echo "Sales invoice"; break;
              case 'G': echo "PO invoice"; break;
              default:  echo "General ledger"; break;
            }
          ?>
        </td>
        <!-- <td>-</td> -->
...
<div class="dt-responsive table-responsive">
  <table class="table table-striped table-bordered">
    ...
    <tbody>
      ...
      ?>
      <tr>
        <td colspan="7" class="text-center text-muted">No Input (DR) vouchers found.</td>
      </tr>
      <?php } ?>
    </tbody>
