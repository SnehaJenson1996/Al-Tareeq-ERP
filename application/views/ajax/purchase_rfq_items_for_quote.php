...
<td>
   <select class="form-control" name="item_unit[]" style="min-width:120px;">
    <option value="<?php echo $r->item_unit; ?>" selected>
        <?php echo $r->unit_name; ?>
    </option>
</select>
</td>        <!-- <td><select class="form-control" name="item_packing[]"><option>CTN</option></select></td> -->
        
        <td><input type="number" class="form-control unit_price" name="unit_price[]" step='any' id="unit_price<?php echo $i; ?>" value="<?php echo $r->mrp_aed; ?>"/></td>
