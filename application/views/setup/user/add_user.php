	...
	<div class="col-md-12 col-sm-12 ">
		<div class="x_panel">
			...
			<br />
				...
				<form action="<?php echo base_url().'index.php/'; ?>Setup/add_user_data" method="post" autocomplete='off'>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input type="text" id="user_login" name="user_login" required="required" readonly onfocus="this.removeAttribute('readonly');" class="form-control">
						</div>
					</div>
					<div class="item form-group">
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<div id="gender" class="btn-group" data-toggle="buttons">
								<label class="btn btn-secondary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default"><input type="radio" name="gender" value="M" class="join-btn"> &nbsp; Male &nbsp;</label>
								<label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default"><input type="radio" name="gender" value="F" class="join-btn"> Female</label>
							</div>
						</div>
					</div>
