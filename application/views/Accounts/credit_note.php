<div class="x_panel">
  <div class="x_title">
    <h2>Credit Note Entry <small>Add / Manage Credit Notes</small></h2>
    <div class="clearfix"></div>
  </div>

  <div class="x_content">
    <form class="form-horizontal form-label-left" 
          action="<?php echo base_url().'index.php/accounts/add_credit_note'; ?>" 
          id="receipt" method="post" name="receipt">
      
      <!-- Row: Date -->
      <div class="form-group row">
        <label class="col-md-2 col-sm-3 col-form-label">Select Date <span class="text-danger">*</span></label>
 ...
 <label class="control-label col-md-2 col-sm-3 col-xs-12">
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
              ...
              <tr id="dr_addr0">
                <td>
                  <select class="form-control form-control-sm select2" 
                          id="debtor0" name="debtor[]" 
                          onchange="get_account_balance(0,'dr')" required>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-3">
          <input type="text" id="debit_total" name="debit_total" 
                 class="form-control bg-light" readonly>
        </div>

        <label class="col-md-2 col-form-label">Credit Total</label>
        <div class="col-md-3">
          <input type="text" id="credit_total" name="credit_total" 
                 class="form-control bg-light" readonly>
        </div>
      </div>
