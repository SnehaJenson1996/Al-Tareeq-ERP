...
<!-- Header Logo -->
<!-- <table style="width:100%; border-collapse:collapse; margin-top:0; margin-bottom:5px;">
    <tr>
        <td style="width:100%; vertical-align:top;">
            <img src="<?= $headerPath ?>" alt="Company Logo" 
                 style="width:90%; max-height:100px; height:auto; display:block; margin:0 auto;">
        </td>
    </tr>
</table> -->
...
<table style="width:100%; border-collapse:collapse; margin-bottom:15px;">
    <tr>
        <td style="width:600%; padding:30px 20px 20px 20px;">
<img src="<?= $headerPath ?>" class="header-img" style="max-height:120px;">        </td>
    </tr>
</table>
...
<table style="width:100%; border-collapse:collapse; margin-bottom:15px;">
    ...
    Project: <?= $project_name ?? $quotation['project_name'] ?? '-' ?>
</div>
...
<div style="font-size:14px;">
    Location: <?= $project_location ?? '-' ?>
        ...
        <td style="width:50%; text-align:right; vertical-align:middle; padding:10px;">
            <div style="font-size:20px; font-weight:bold; color:#2C2C2C;">Delivery Note</div>
