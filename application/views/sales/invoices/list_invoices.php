              ...
              <tbody>
                ...
                foreach ($active_invoice_list as $invoice) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url() . 'index.php/Sales/edit_invoice/' . $invoice['invoice_id'] ?>">
                        <?php echo $invoice['invoice_code']; ?><br>
                    ...
                    <td>
                      ...
                      <a target="_blank"
   href="<?= base_url('index.php/Sales/generate_einvoice_xml/'.$invoice['invoice_id']) ?>"
