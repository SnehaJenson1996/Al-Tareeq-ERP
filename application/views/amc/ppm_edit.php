<div class="card-body">
	<form id="main" method="post" action="<?php echo base_url().'index.php/'; ?>AMC/update_ppm_data" autocomplete="off" enctype="multipart/form-data">
...
<input type="text" class="form-control"
       value="<?php echo $row->project_name.' | '.$row->customer_name; ?>"
       readonly>			<input type="hidden" name="ppm_id" value="<?php echo $row->ppm_id; ?>"/>
    	    </div>
		    ...
		    <div class="col-xs-12 col-sm-9 col-md-3 col-lg-2">
				    <input type="text" class="form-control form-control-sm " id="ppm_code" name="ppm_code" value="<?php echo $row->ppm_code;?>" tabindex='3' readonly>
			</div>
            <label class="col-xs-12 col-sm-3 col-md-3 col-lg-1 col-form-label"> Date <span style="color: red;"> * </span></label>
		    <div class="col-xs-12 col-sm-9 col-md-3 col-lg-2">
						                  
		    			<input type="text" class="form-control form-control-sm " id="ppm_date" name="ppm_date" value="<?php echo $row->ppm_date;?>" required tabindex='3' readonly>
		...
		<div class="form-group row">
			...
			<label class="col-xs-12 col-sm-1 col-md-2 col-lg-2 col-form-label">Number of PPM</label>
	    	    <div class="col-xs-12 col-sm-9 col-md-6 col-lg-3">
			      <input type="text" name="no_of_sch" id="no_of_sch" class="form-control" value="<?php echo $row->no_of_sch; ?>" readonly/> 
		     </div>	
        ...
        <table class="table table-striped" id="dataTable1" width="150%">
			...
			<tr id="row0">
				...
				<td><input type="text" class="form-control" id="ppm_num0" name="ppm_num[]" value="<?php echo $r->ppm_num; ?>"></td>
				<td><input type="date" class="form-control" id="ppm_sch_date0" name="ppm_sch_date[]" value="<?php echo $r->ppm_sch_date; ?>"></td>
				<td><input type="date" class="form-control" id="ppm_finish_date0" name="ppm_finish_date[]" value="<?php echo $r->ppm_finish_date; ?>"></td>
				<td><input type="text" class="form-control" id="ppm_amt0" name="ppm_amt[]" value="<?php echo $r->ppm_amt; ?>"></td>
				<td><input type="text" class="form-control" id="ppm_remarks0" name="ppm_remarks[]" value="<?php echo $r->ppm_remarks; ?>"></td>
				<td>
					<select class="form-control" id="ppm_status0" name="ppm_status[]">
						<option <?php if($r->ppm_status=="Scheduled") echo 'selected'; ?> value="Scheduled">Scheduled</option>
						<option <?php if($r->ppm_status=="Finished") echo 'selected'; ?> value="Finished">Finished</option>
		...
		<div class="form-group row">	
		<h6>PPM Schedule Details</h6>	    
		<div style="overflow:auto;width:100%;">	     	
        <table id="dataTable2" style="margin-top:3%; width:150%" >
			<thead>
				<tr>
					<th width="5%">Sr.No</th>
					<th width="10%">PPM</th>
					...
					<th width="5%">No:of Equipments</th>
					<th width="8%">Rate</th>
					<th width="8%">Total</th>
					<th width="10%">Technician</th>
					<th width="15%">Remarks</th>
					<th width="10%">Status</th>
					<th width="5%"><a onclick="addRow2()"><span class="fa fa-plus"></span></a></th>
				</tr>
			</thead>
			<tbody>
			<?php if (!empty($detail_records)){
				$i=5001;
				foreach ($detail_records as $d){?> 
			<tr id="row0">
				<td><input type="text" class="form-control" id="sr_no0" name="sr_no[]" value="<?php echo $d->sr_no; ?>"></td>
				<td><input type="text" class="form-control" id="ppmnum0" name="ppmnum[]" value="<?php echo $d->ppmnum; ?>"></td>
				<td><input type="text" class="form-control" id="ppm_building0" name="ppm_building[]" value="<?php echo $d->ppm_building; ?>"></td>
				<td><input type="text" class="form-control" id="ppm_flat0" name="ppm_flat[]" value="<?php echo $d->ppm_flat; ?>"></td>
				<td><input type="date" class="form-control" id="ppm_visit_date0" name="ppm_visit_date[]" value="<?php echo $d->ppm_visit_date; ?>"></td>
				
				<td><input type="text" class="form-control" id="ppm_acnum0" name="ppm_acnum[]" value="<?php echo $d->ppm_acnum; ?>" onkeyup="calculate_cost(0);"></td>
				<td><input type="text" class="form-control" id="ppm_rate0" name="ppm_rate[]" value="<?php echo $d->ppm_rate; ?>" onkeyup="calculate_cost(0);"></td>
				<td><input type="text" class="form-control" id="ppm_cost0" name="ppm_cost[]" value="<?php echo $d->ppm_cost; ?>"></td>

				<td><input type="text" class="form-control" id="ppm_tech0" name="ppm_tech[]" value="<?php echo $d->ppm_tech; ?>"></td>
				<td><input type="text" class="form-control" id="ppm_notes0" name="ppm_notes[]" value="<?php echo $d->ppm_notes; ?>"></td>
				
				<td>
					<select class="form-control" id="ppmstatus0" name="ppmstatus[]">
						<option <?php if($d->ppmstatus=="Scheduled") echo 'selected'; ?> value="Scheduled">Scheduled</option>
						<option <?php if($d->ppmstatus=="Pending") echo 'selected'; ?> value="Pending">Pending</option>
...
function addRow2() {
  ...
  cell5.innerHTML = '<input type="date" class="form-control" id="ppm_visit_date' + rowNum + '" name="ppm_visit_date[]">';
  cell6.innerHTML = '<input type="text" class="form-control" id="ppm_acnum' + rowNum + '" name="ppm_acnum[]" onkeyup="calculate_cost(' + rowNum + ');">';
  cell7.innerHTML = '<input type="text" class="form-control" id="ppm_rate' + rowNum + '" name="ppm_rate[]" onkeyup="calculate_cost(' + rowNum + ');" value="50">';
