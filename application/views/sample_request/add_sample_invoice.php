    ...
    <div class="clearfix"></div>
        ...
        <form action='<?php echo base_url().'index.php/'; ?>SampleRequest/add_sample_invoice' method='post' >
        <div class="x_content">
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <select class="form-control" name="request_id" id="request_id" onchange='this.form.submit()'>
                        ...
                        <?php foreach($sample_requests as $req) { ?>
        ...
        <form action='<?php echo base_url().'index.php/'; ?>Sales/add_invoice_data' method='post' >
            <div class="x_content">
                <input type='hidden' name='pi_id' value='<?php echo $request['request_id']; ?>' />
                    ...
                    <table id="datatable" class="table-striped table-bordered" style="width:100%;font-size:10px">
                                ...
                                foreach($request_details as $detail){ ?>
                                    <?php 
                                        ...
                                        //$vat_percent = $request['vat_percent']/100;
                                        $rate = $detail->mrp_aed;
                                    ...
                                    <tr id='<?php echo 'addr'.$i; ?>'>
                                        ...
                                        <td><?php echo $detail->item_model.' '.$detail->item_description ?><input type='hidden' name='detail_id[]' id='<?php echo 'detail_id'.$i; ?>' value='<?php echo $detail->pi_detail_id; ?>' /></td>
                                        ...
                                        <td class='right-align'><?php //echo $request['vat_percent'].'%'; ?></td>
                                ...
                                <tr class='right-align'>
                                    ...
                                    <td><input type='hidden' id='vat_percent' name='vat_percent' value='<?php //echo $request['vat_percent']; ?>' /><span id='total_vat'><?php echo $total_vat_amount; ?></span></td>
            ...
            <div class="x_content">
                        ...
                        <div class="item form-group">  
                            ...
                            <div class="col-md-8">
                            <button type="submit" class="btn btn-success btn-primary">Generate Invoice</button>
                            </div>
                        </div>
