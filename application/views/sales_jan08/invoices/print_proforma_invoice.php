...
<table style="width:100%; border-collapse:collapse; margin-bottom:15px;">
    <tr>
        <td style="width:100%; text-align:right; vertical-align:middle; padding:10px;">
            <div style="font-size:20px; font-weight:bold; color:#2C2C2C;">Proforma Invoice</div>
            <div style="font-size:12px;"><?= $so_master['so_code'] ?> (Rev <?= $so_master['so_revision'] ?>)</div>
            <div style="font-size:12px;"><?= date('d-m-Y', strtotime($so_master['so_date'])) ?></div>
        </td>
    </tr>
</table>
