                            ...
                            <table class="table table-bordered productTable mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="products[<?= $i ?>][<?= $j ?>][<?= $k ?>][quantity]" value="<?= $prod['quantity'] ?>" class="form-control estimation_edit qty" readonly></td>
                                        <td><input type="number" step="0.01" name="products[<?= $i ?>][<?= $j ?>][<?= $k ?>][unit_price]" value="<?= $prod['unit_price'] ?>" class="form-control estimation_edit unitPrice" readonly></td>
                                        <td><input type="number" step="0.01" name="products[<?= $i ?>][<?= $j ?>][<?= $k ?>][amount]" value="<?= $prod['amount'] ?>" class="form-control estimation_edit amount" readonly></td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Sub Total</label>
                            <div class="col-sm-8">
                                <input type="text" name="sub_total" id="subtotal" class="form-control" value="<?= isset($master['sub_total'])?$master['sub_total']:"" ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Freight (%)</label>
                            <div class="col-sm-4">
                                <input type="text" name="freight_percentage" id="freightPercent" class="form-control estimation_edit" value="<?= isset($master['freight_percentage'])?$master['freight_percentage']:"" ?>"readonly>
                            </div>
                            <div class="col-sm-4">
                                <input type="text" name="freight_amount" id="freightAmount" class="form-control estimation_edit" value="<?= isset($master['freight_amount'])?$master['freight_amount']:"" ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Travel Expense</label>
                            <div class="col-sm-8">
                                <input type="text" name="travel_expense" id="travelExpense" class="form-control estimation_edit" value="<?= isset($master['travel_expense'])?$master['travel_expense']:"" ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Inspection Cost</label>
                            <div class="col-sm-8">
                                <input type="text" name="inspection_cost" id="inspectionCost" class="form-control estimation_edit" value="<?= isset($master['inspection_cost'])?$master['inspection_cost']:"" ?>" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Margin (%)</label>
                            <div class="col-sm-4">
                                <input type="text" name="margin_percentage" id="marginPercent" class="form-control estimation_edit" value="<?= isset($master['margin_percentage'])?$master['margin_percentage']:"" ?>" readonly>
                            </div>
                            <div class="col-sm-4">
                                <input type="text" name="margin_amount" id="marginAmount" class="form-control estimation_edit" value="<?= isset($master['margin_amount'])?$master['margin_amount']:"" ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Bank Charge</label>
                            <div class="col-sm-8">
                                <input type="text" name="bank_charge" id="bankCharge" class="form-control estimation_edit" value="<?= isset($master['bank_charge'])?$master['bank_charge']:"" ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Other Expense</label>
                            <div class="col-sm-8">
                                <input type="text" name="other_expense" id="otherExpense"  class="form-control estimation_edit"value="<?= isset($master['other_expense'])?$master['other_expense']:"" ?>"  readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="total_cost" id="totalCost" class="form-control font-weight-bold" value="<?= isset($master['grand_total'])?$master['grand_total']:"" ?>" readonly>
                            </div>
                        </div>
                    </div>
