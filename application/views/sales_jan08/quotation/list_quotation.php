                ...
                foreach ($quotations as $qtn) { ?>
                  <tr>
                    ...
                    <td>
                      ...
                      } elseif ($qtn['aproval'] == 0) {
                        echo '<span class="badge bg-warning text-dark approve-btn" data-id="' . $qtn['qtn_id'] . '">Approve</span>'; // yellow
                      } else {
                        echo '<span class="badge bg-secondary">' . $qtn['quotation_status'] . '</span>'; // grey
                      }
                      ?>
                    ...
                    <td>
                      ...
                      </a> <a href="<?= base_url('index.php/Sales/view_quotation/' . $qtn['qtn_id']); ?>" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
