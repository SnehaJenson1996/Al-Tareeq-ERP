        ...
        <?php if (!empty($qtn_products)): ?>
            <?php foreach ($qtn_products as $i => $item): ?>
                <tr>
                    ...
                    <td>
                        <input type="text" name="so_discount[]" value="<?= $item['dicount_amount'] ?>" class="form-control so_discount">
                    </td>
                    <td>
                        <input type="text" name="so_taxable[]" value="<?= number_format((($item['available_qty'] * $item['unit_price']) - $item['dicount_amount']), 2) ?>" class="form-control so_taxable" readonly>
                    </td>
                    <td>
