                ...
                <form action="<?= base_url() ?>index.php/Sales/save_sales_order" method="post">
                    ...
                    <table class="table table-bordered" style="width:100%; border-collapse:collapse; font-size:13px; margin-bottom:20px;">
                        <tr>
                            ...
                            <td colspan="2">
                                <select class="form-control" name="quotation_id" id="quotation_id">
                                    <option value="">Select Quotation</option>
                                    <?php foreach ($approved_quotations as $approved_quotation) { ?>
                                        <option value="<?php echo $approved_quotation['qtn_id']; ?>"
                                            <?= isset($selected_quotation) && $selected_quotation == $approved_quotation['qtn_id'] ? 'selected' : '' ?>>
                                            <?php echo $approved_quotation['quotation_code'] . '/Rev-' . $approved_quotation['quotation_revision']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input type="date" name="so_date" class="form-control" value=""></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // ✅ 2. Now handle pre-selection and trigger
        var selected = <?php echo json_encode(isset($selected_quotation) ? $selected_quotation : ''); ?>;
