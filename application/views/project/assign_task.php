...
<form id="project_form" action="<?= base_url('index.php/Project/act_assign_task') ?>" method="post">
...
function addTask(){
    ...
    html+='<input type="text" name="task_name[]" class="form-control" value="" required>';
    html+='</div>';

    html+='<div class="col-md-3">';
    html+='<label>Milestone</label>';
    html+='<select name="milestone[]" class="form-control"  value="" required>';
    html += m_options;
    html+='</select>';
    html+='</div>';
   ...
   // Designation
    ...
    html+='<select name="designation_id[]" class="form-control designation_select"  value="" required>';
    ...
    html+='<input type="date" name="start_date[]" class="form-control"  value="" required>';
    html+='</div>';

    html+='<div class="col-md-3">';
    html+='<label>End Date</label>';
    html+='<input type="date" name="end_date[]" class="form-control"  value=""  required>';
    html+='</div>';
