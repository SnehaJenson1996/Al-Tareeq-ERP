    ...
    <div class="x_title">
        ...
        <div class="clearfix">
            ...
            <button type="button" 
                    ...
                    onclick="window.open('<?= base_url('index.php/Sales/print_estimation/'.$estimations['estimation_id'].'/'.$estimations['enquiry_id']) ?>', '_blank');">
                🖨 Print
            </button>
        </div>
        </div>
...
<strong><?= strtoupper($estimations['customer_name']) ?> - <?= strtoupper($estimations['enquiry_code']) ?></strong>
