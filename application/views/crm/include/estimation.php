    ...
    <?php if (isset($estimation_revisions) && (!empty($estimation_revisions))) { ?>
        <div class="revisions-list">
            <?php $i = 1; foreach ($estimation_revisions as $revision_id): ?>
                <a href="<?= base_url('index.php/CRM/estimation_revision/' . $revision_id . '/' . $enquiry_data['enquiry_id']) ?>"
                   target="_blank"
                   class="revision-link">
                    Revision <?= $i; ?>
                </a>
...
<?php if (!empty($menu_status) && $menu_status == 3): ?>
    ...
    <form action="<?= base_url() ?>index.php/CRM/save_estimation" id="estimationForm" method="post">
...
<?php if (!empty($enquiry_data['enquiry_status']) && ($enquiry_data['enquiry_status'] >= 4)): ?>    
    ...
    <div class="form-group row align-items-center">
        ...
        <!-- Print Button -->
       <?php if (!empty($master['estimation_id'] ?? null)): ?>
    <div class="text-end mb-3">
        <button type="button"
                class="btn btn-primary"
                onclick="window.open(
                    '<?= base_url('index.php/Document_controller/print_estimation/'
                        . $master['estimation_id'] . '/'
                        . $enquiry_data['enquiry_id']) ?>/1',
                    '_blank'
                );">
            🖨 Print
        </button>
...
<?php endif; ?>
    ...
    <form action="<?= base_url()?>index.php/CRM/update_estimation" method="post">
