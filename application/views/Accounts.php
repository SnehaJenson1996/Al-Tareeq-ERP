  ...
  public function view_profit_and_loss()
{
    ...
    $data['sales_accounts']    = $this->Accounts_model->get_sales_accounts($from, $to);
    $data['purchase_accounts'] = $this->Accounts_model->get_purchase_accounts($from, $to);
    $data['direct_income']     = $this->Accounts_model->get_direct_income($from, $to);
    $data['direct_expense']    = $this->Accounts_model->get_direct_expense($from, $to);
    $data['indirect_income']   = $this->Accounts_model->get_indirect_income($from, $to);
    $data['indirect_expense']  = $this->Accounts_model->get_indirect_expense($from, $to);
...
public function daily_transaction_report()
{
    ...
    // GET DAY BOOK DATA
    $data['daybook_records'] = $this->Accounts_model->get_daybook($from_date, $to_date);
