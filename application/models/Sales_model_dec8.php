...
class Sales_model extends CI_Model
{
    ...
    public function get_quotation_full_details($enquiry_id)
    {
        ...
        qm.aproval, qm.approved_by, qm.quotation_status, qm.quotation_revision, qm.created_on, qm.updated_on,qm.other_charge,
    ...
    public function get_quotation_details_by_id($qtn_id)
    {
        ...
        return $query->row_array(); // fetch only one quotation record
    }
